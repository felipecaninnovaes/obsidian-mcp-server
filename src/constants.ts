...
/** Returns the vault-absolute path for the embeddings persistence directory. */
export function getEmbeddingStorageDir(configDir: string): string {
	return `${configDir}/plugins/obsidian-mcp-server/embeddings`;
}
